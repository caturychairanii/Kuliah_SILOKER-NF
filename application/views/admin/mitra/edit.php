	...
	<div class="row">
		<div class="col-lg-12">
			<div class="card" style="width: 100%; height: 100%;"><br>
				<h3 style="margin-left: 20px;">Ubah Data Mitra</h3><hr>
				<form action="<?= base_url('index.php/admin/mitra/updatData/'.$mitra->id) ?>" method="post">
					<div  class="row" >
						<div class="col-md-10" style="margin-left: 20px ; ">
							<div class="form-group">
								<label>Nama</label>
								<input type="text" name="nama" value="<?= $mitra->nama; ?>" class="form-control" autocomplete="off">
							</div>
						</div>
						<div class="col-md-10" style="margin-left: 20px ; ">
							<div class="form-group">
								<label>Email</label>
								<input type="text" name="email" value="<?= $mitra->email; ?>" class="form-control" autocomplete="off">
							</div>
						</div>
						<div class="col-md-10" style="margin-left: 20px ; ">
							<div class="form-group">
								<label>Kontak</label>
								<input type="text" name="kontak" value="<?= $mitra->kontak; ?>" class="form-control" autocomplete="off">
							</div>
						</div>
						<div class="col-md-10" style="margin-left: 20px ; ">
							<div class="form-group">
								<label>Telpon</label>
								<input type="text" name="telpon" value="<?= $mitra->telpon; ?>" class="form-control" autocomplete="off">
							</div>
						</div>
						<div class="col-md-10" style="margin-left: 20px ; ">
							<div class="form-group">
								<label>Web</label>
								<input type="text" name="web" value="<?= $mitra->web; ?>" class="form-control" autocomplete="off">
							</div>
						</div>
						<div class="col-md-10" style="margin-left: 20px ; ">
							<div class="form-group">
						...
						<div class="col-md-10" style="margin-left: 20px ; ">
							<div class="form-group">
								<label>Alamat</label>
								<textarea name="alamat" class="form-control"><?= $mitra->alamat; ?></textarea>
							</div>
						</div>
					</div>
					<br>
